...
public class ElasticQuery<E extends ElasticEntity> extends Query<ElasticQuery<E>, E, ElasticConstraint> {
     ...
     * <p>
     * It is recommended to sort by {@link Elastic#ID_FIELD_MAPPING} when using this. Note that this gracefully
     ...
     * <p>
     * Note that this will automatically return "-" if no more results are expected. Use this in conjuction with
     * {@link #searchAfter(String)} and sort queries by {@link Elastic#ID_FIELD_MAPPING}.
     *
