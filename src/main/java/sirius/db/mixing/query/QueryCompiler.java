 ...
 * given list of {@link #searchFields}. It also supports boolean operations like AND and OR as
 ...
 * </ul>
 * <p>
 * If the underlying mapper allows it (e.g. {@link sirius.db.jdbc.OMA}), a field can be a
 * path like <tt>parent.tenant.name</tt> and will be transformed into an appropriate JOIN
 ...
 * wrong or if this is simply a complex search term (e.g. value:XX). Therefore we provide some ways of recovering or
...
public abstract class QueryCompiler<C extends Constraint> {
    ...
    protected static class FieldValue {
         ...
         *
         * @return the parsed (and transformed) value
         */
        ...
        /**
         * Determines if the value must not be processed any further.
         *
         * @return <tt>true</tt> if the value was explicitly given (e.g. in quotes), <tt>false</tt> otherwise
         */
     ...
     * a constraint, a regular search in the default fields is generated. This might be necessary so that tokens like
    ...
    /**
     * Generates a constraint which tries to find the given token in the given <tt>searchFields</tt>.
     *
